...
<fmt:message key="delete.warning" var="delete_warning"/>
...
<c:choose>
    ...
    <c:otherwise>
        <c:forEach items="${requestScope.bankcard_numbers}" var="bankcard_number">
            <div class="bankcard">
                <form action="mainController" method="post" onsubmit="alert('${delete_warning}');">
                    ...
                    <input type="hidden" name="bankcard_number" value="${bankcard_number}">
                    <c:choose>
                    ...
                    <div class="bankcard-delete"><button type="submit">&#10006;</button></div>
                </form>
