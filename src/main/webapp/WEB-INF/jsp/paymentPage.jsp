...
<title>${payment_title} ${order.car.brand} ${order.car.model} ${order.car.yearProduction}</title>
...
<div id="content">
    <div class="container main-content">
        <div id="order-payment">
            ...
            <c:if test="${pageContext.request.getParameter(\"payment\") eq 'incorrect_data'}">
                <p class="error-message2">${incorrect_data}</p>
            </c:if>
